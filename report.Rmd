...
With our trend visualization and regression analysis, we are now able to answer the questions we raised at the beginning. The trend of avocado price and consumption in US over the year indeed differs based on the type. While they share similar seasonal and yearly fluctuation patterns, conventional avocado overall has lower price and higher consumption. The avocado price and consumption vary depending on geographical regions to a certain extent, and the association is significant especially for North East, South Central, and West. We found that people from Plains, MidSouth, Great Lakes and NorthEast loves large avocado the most while people from SouthEast, SouthCental, California and West love the samll avocade most. GDP, which hypothetized as an predictor, has little impact on the avocado price and consumption, 
